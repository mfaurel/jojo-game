...
export const COUNTING_LEVELS = [
    // 2 types, count 1–3, 5 s — easy intro
    {
        id: 0, types: 2, maxCount: 3, showTime: 5000,
        pool: ['CHAT', 'OURS', 'LAPIN', 'VACHE', 'CHIEN'],
    },
    // 2 types, count 1–4, 5 s — more pieces
    {
        id: 1, types: 2, maxCount: 4, showTime: 5000,
        pool: ['VACHE', 'LAPIN', 'PONEY', 'POULE', 'CHIEN'],
    },
    // 3 types, count 1–4, 5 s — one more kind
    {
        id: 2, types: 3, maxCount: 4, showTime: 5000,
        pool: ['CHAT', 'OURS', 'LAPIN', 'VACHE', 'CHIEN'],
    },
    // 3 types, fruits, count 1–5, 5 s
    {
        id: 3, types: 3, maxCount: 5, showTime: 5000,
        pool: ['KIWI', 'POMME', 'POIRE', 'FIGUE', 'PRUNE'],
    },
    // 3 types, mixed, count 1–5, 4 s — less time
    {
