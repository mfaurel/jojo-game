...
- On the math world, the emoji are cropped at the top, fix it
- On the math world, during a game, the screen for input numbers is not centered
- On the math world, stop shaking the screen when it's a wrong innput
